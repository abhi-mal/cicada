...
def get_student_targets(
    ...
    dataset = gen.get_generator(X.reshape((-1, 18 * 14 * 3, 1)), y, 1024, True)
    # fixing memory leak
    del X_hat
    del y
    gc.collect()
...
def main(args) -> None:
    ...
    teacher = TeacherAutoencoder((18, 14, 3)).get_model()
    ...
    cicada_v2 = CicadaV2((756,)).get_model()#252*3=756
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action=CreateFolder,
        type=Path,
        default="models_rand_only_student_epochs40_input_ntuplizer/",
